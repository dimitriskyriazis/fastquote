...
export default function OfferProductsPivotPanel({ offerId, refreshToken = 0, onExitPivot, layout }: Props) {
  ...
  const columnDefs = useMemo<ColDef<RowData>[]>(() => ([
    ...
    { field: 'NetCost', headerName: 'Net Cost', filter: 'agNumberColumnFilter', valueGetter: numericFieldValueGetter('NetCost'), valueFormatter: euroValueFormatter, aggFunc: 'sum' },
    { field: 'TotalCost', headerName: 'Total Cost', filter: 'agNumberColumnFilter', valueGetter: numericFieldValueGetter('TotalCost'), valueFormatter: euroValueFormatter, aggFunc: 'sum' },
    { field: 'GrossProfit', headerName: 'Gross Profit', filter: 'agNumberColumnFilter', valueGetter: numericFieldValueGetter('GrossProfit'), valueFormatter: euroValueFormatter, aggFunc: 'sum' },
    { field: 'Margin', headerName: 'Margin %', filter: 'agNumberColumnFilter', valueGetter: numericFieldValueGetter('Margin'), valueFormatter: percentValueFormatter, aggFunc: 'avg' },
    ...
    { field: 'TelmacoDiscount', headerName: 'Telm Disc %', filter: 'agNumberColumnFilter', valueGetter: numericFieldValueGetter('TelmacoDiscount'), valueFormatter: percentValueFormatter, aggFunc: 'avg' },
    {
