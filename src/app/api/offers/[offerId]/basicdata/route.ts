...
const FIELD_CONFIG: Record<OfferBasicUpdateField, FieldConfig> = {
  ...
  DraftRequestDate: { column: 'DraftRequestDate', type: 'date', sqlType: sql.DateTime2 },
  DraftOfferDate: { column: 'DraftOfferDate', type: 'date', sqlType: sql.DateTime2 },
  RequestDate: { column: 'RequestDate', type: 'date', sqlType: sql.DateTime2 },
