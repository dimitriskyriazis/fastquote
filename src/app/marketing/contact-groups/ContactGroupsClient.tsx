...
export default function ContactGroupsClient() {
  ...
  const columnDefs = useMemo<ColDef[]>(
    () => [
      ...
      { field: "Description", headerName: "Description", filter: "agTextColumnFilter", editable: true, flex: 1 },
      { field: "Division", headerName: "Division", filter: "agTextColumnFilter", editable: true },
      { field: "GroupImportance", headerName: "Group Importance", filter: "agTextColumnFilter", editable: true, width: 150 },
      { field: "Note", headerName: "Note", filter: "agTextColumnFilter", editable: true },
      { field: "TotalCount", headerName: "Total Count", filter: "agNumberColumnFilter", editable: false, width: 110 },
      { field: "Importance1", headerName: "Imp 1", filter: "agNumberColumnFilter", editable: false, width: 80 },
      { field: "Importance2", headerName: "Imp 2", filter: "agNumberColumnFilter", editable: false, width: 80 },
      { field: "Importance3", headerName: "Imp 3", filter: "agNumberColumnFilter", editable: false, width: 80 },
      {
        field: "Enabled",
        headerName: "Enabled",
