...
export default function ContactGroupsClient() {
  ...
  const columnDefs = useMemo<ColDef[]>(
    () => [
      ...
      { field: "GroupImportance", headerName: "Group Importance", filter: "agTextColumnFilter", editable: true },
      ...
      { field: "Importance1", headerName: "Imp 1", filter: "agNumberColumnFilter", editable: false },
      { field: "Importance2", headerName: "Imp 2", filter: "agNumberColumnFilter", editable: false },
      { field: "Importance3", headerName: "Imp 3", filter: "agNumberColumnFilter", editable: false },
      {
        field: "Enabled",
        headerName: "Enabled",
