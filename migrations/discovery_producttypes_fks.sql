-- Discovery: list every FK pointing at dbo.ProductTypes.
-- Run this BEFORE 2026-04-19_align_producttypes_with_soft1.sql.
-- Expected: a single row showing dbo.Products.TypeID.
-- If anything else appears, the migration script must be extended.
...
WHERE fk.referenced_object_id = OBJECT_ID('dbo.ProductTypes');
